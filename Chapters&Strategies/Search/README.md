...
int array_searcj(int arr[], int n, int value);
void array_in(int arr[], int size);   
void array_print(int arr[], int size);
...
bool array_max(int arr[], int n, int value)  
{   
    for (int i = 0; i < n-1; i++)
    {
        if(arr[i] == value)
