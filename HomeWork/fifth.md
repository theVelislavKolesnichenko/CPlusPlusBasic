...
Съставете програма която извежда простите числа от 1 до 20 с помоща на функция. Функцията приема като параметър число и връща като резултат истина или лъжа. // Условието не се разбира
